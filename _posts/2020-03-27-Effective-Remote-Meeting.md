...
オフサイトとオンラインのハイブリッド状態のリモート会議は弊害が非常に多いからだ。たとえば、よくあるのは共通のカンファレンスマイクから距離が遠いメンバの声が聞こえない、というケースだ。その他にも、カンファレンスマイクをミュートに頻繁にするわけでもないので、会議室の近くの廊下の音や、ドアの開閉音を拾ってしまい、集中を乱すノイズ源になりやすい。
...
たとえば、オフサイトで10人が集まる会議室で、カンファレンスマイクを中央に置く場合、端っこにいる参加者の声はきちんと拾えているだろうか？（もし、会議を録画しているなら、ビデオを再生して音質・音量を確かめてみると良い）
